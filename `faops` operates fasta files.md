...
ps: 
make的过程中需要先安装gcc
（安装：$ sudo apt-get  install  build-essential，查看版本：$ gcc --version）
...
#### 7.1.  Tidy fasta file to 80 characters ofsequence per line
...
#### 7.2.  All content written on one line
...
#### 10.3.    Compute N90, sum and average ofcontigs with estimated genome size
